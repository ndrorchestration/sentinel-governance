...
**Known stale references found this session:**
- `sentinel-governance/.github/workflows/governance.yml` — `zricethezav/gitleaks-action@v2.1.2` (old org name, not updated by root-file fix)
...
**Affected files identified (2026-04-29):**
- `Driftwatch/AGENTS.md` — full Agent Herald system prompt, no IP header
...
**Affected repos (2026-04-29):**
- `sentinel-governance` — root `governance.yml` exists; `.github/workflows/governance.yml` is the live file and still references `zricethezav/gitleaks-action@v2.1.2`

---

## Session Audit Trail

### 2026-04-29 — Amethyst Coherence Sweep Session
...
**Commits executed this session:**

| Commit | Repo | Pattern Applied |
|---|---|---|
...
| [13fc7bd](https://github.com/Flickerflash/sentinel-governance/commit/13fc7bdfe1a52d0fcac934ed591d3d58977e69f4) | sentinel-governance | NDR-004, NDR-005 |

**Open items remaining after session:**

| ID | Repo | File | Pattern | Status |
|---|---|---|---|---|
| OI-001 | sentinel-governance | `.github/workflows/governance.yml` | NDR-005, NDR-007 | ⏳ Pending |
| OI-002 | Driftwatch | `AGENTS.md` | NDR-006 | ⏳ Pending |
| OI-003 | DGAF-Framework | `SECURITY.md`, `CONTRIBUTING.md` | NDR-004 | ⏳ Pending |
| OI-004 | Driftwatch | `SECURITY.md`, `CONTRIBUTING.md` | NDR-004 | ⏳ Pending |
| OI-005 | Amethyst-Governance-Eval-Stack | `SECURITY.md`, `CONTRIBUTING.md` | NDR-004 | ⏳ Pending |
| OI-006 | junior-apogee-app | `SECURITY.md`, `CONTRIBUTING.md` | NDR-004 | ⏳ Pending |
| OI-007 | ai-governance-frameworks | `CONTRIBUTING.md` | NDR-004 | ⏳ Pending |
